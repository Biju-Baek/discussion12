...
// Question 1
document.querySelector("#host-name").innerHTML = "Biju Baek";
...
//Question 6
let resetRadioButton = document.querySelector("#radio-reset-button") 
resetRadioButton.addEventListener("click", function(){
    let radioButtons = document.querySelectorAll('input[name="favorite_day"]')
